...
const weixin_bridge_markers = [_][]const u8{
    "const ChatopsRequest",
    "const chatops_vtable",
    "fn tabConversationSession",
    "fn chatopsActiveAiTabIndex",
    "fn chatopsTabIndexFromSurfaceId",
    "fn chatopsActiveTerminalSurface",
    "fn chatopsTerminalSurfaceFromId",
    "fn chatopsDispatch",
    "fn wxIsConnected",
    "fn wxFindAiSurface",
    ...
    "var g_chatops_ui_handle",
    "var g_chatops_ctx",
    "var g_chatops_transcript_mutex",
    "var g_chatops_transcript_owned",
    "var g_chatops_pinned_session",
};
