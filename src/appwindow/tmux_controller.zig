...
const impl = switch (builtin.os.tag) {
    ...
    .linux, .macos => @import("tmux_controller_posix.zig"),
        ...
        pub fn start(_: Allocator, _: []const u8, _: []const u8, _: []const u8, _: u16, _: u16, _: u32, _: Config.CursorStyle, _: bool, _: ?@import("../ssh/connection.zig").SshConnection) bool {
            return false;
        }
