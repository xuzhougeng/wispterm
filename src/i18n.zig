...
pub const Strings = struct {
    ...
    settings_start_menu: []const u8,
    settings_startup: []const u8,
    ...
    memory_source_settings: []const u8,
    memory_location_local: []const u8,
    memory_location_disabled: []const u8,
    memory_settings_help: []const u8,
    memory_settings_provider: []const u8,
    memory_settings_location: []const u8,
    memory_settings_saved: []const u8,
    memory_settings_failed: []const u8,
    ...
    sl_delete_selected_ssh_servers: []const u8,
    sl_search_ssh_servers: []const u8,
    sl_cancel: []const u8,
    sl_save: []const u8,
    sl_back: []const u8,
    ...
    // MCP servers panel (mirrors the SSH picker style).
    mcp_servers_title: []const u8,
    mcp_list_hint: []const u8,
    mcp_search: []const u8,
    mcp_new_server: []const u8,
    mcp_edit_json: []const u8,
    mcp_close: []const u8,
    mcp_v_file: []const u8,
    mcp_add_title: []const u8,
    mcp_edit_title: []const u8,
    mcp_form_hint: []const u8,
    mcp_test: []const u8,
    mcp_delete: []const u8,
...
const en = Strings{
    ...
    .settings_start_menu = "Windows Start menu",
    .settings_startup = "Start when signing in",
    ...
    .memory_source_settings = "Source settings",
    .memory_location_local = "Local computer",
    .memory_location_disabled = "Location disabled",
    .memory_settings_help = "Each location has its own tools. Toggle the location to enable or pause collection; its tool choices are retained. Changes are saved immediately for the next digest. Existing summaries are kept.",
    .memory_settings_provider = "Chat history tool",
    .memory_settings_location = "Collection location",
    .memory_settings_saved = "Source settings saved",
    .memory_settings_failed = "Could not save source settings",
    .memory_footer = "Tab / Left / Right: source   Up / Down: select   Space: toggle   D: run digest",
    ...
    .sl_delete_selected_ssh_servers = "Delete Selected",
    .sl_search_ssh_servers = "Search SSH servers",
    .mcp_servers_title = "MCP Servers",
    .mcp_list_hint = "Type to filter \u{00b7} Enter edits \u{00b7} Space enable/disable",
    .mcp_search = "Search MCP servers",
    .mcp_new_server = "New MCP Server",
    .mcp_edit_json = "Edit mcp.json",
    .mcp_close = "Close",
    .mcp_v_file = "file",
    .mcp_add_title = "Add MCP Server",
    .mcp_edit_title = "Edit MCP Server",
    .mcp_form_hint = "Enter saves \u{00b7} Tab/\u{2191}\u{2193} move \u{00b7} Esc back",
    ...
    .sl_hint_ssh_filter_choose_delete = "Type to filter, Space selects, Enter deletes selected",
    .sl_hint_choose_server_delete = "Space selects, Enter deletes selected",
    .sl_ai_profile_name = "Profile name",
    .sl_ai_base_url = "Base URL",
    .sl_ai_api_key = "API key",
    .sl_ai_acp_not_needed = "(not needed for ACP)",
    ...
    .cmd_palette_filter_placeholder = "Execute a command or pick a theme…",
...
const zh_CN = Strings{
    ...
    .settings_start_menu = "Windows 开始菜单",
    .settings_startup = "开机启动",
    ...
    .memory_source_settings = "来源配置",
    .memory_location_local = "本机",
    .memory_location_disabled = "此位置已停用",
    .memory_settings_help = "每个位置独立选择下级工具。勾选位置以启用采集，停用位置时保留其工具选择。修改立即保存，下次生成摘要时生效，已有摘要保留。",
    .memory_settings_provider = "聊天记录工具",
    .memory_settings_location = "采集位置",
    .memory_settings_saved = "来源配置已保存",
    .memory_settings_failed = "保存来源配置失败",
    .memory_footer = "Tab / 左 / 右：切换来源   上 / 下：选择   空格：勾选   D：运行摘要",
    ...
    .sl_delete_selected_ssh_servers = "删除选中服务器",
    .sl_search_ssh_servers = "搜索 SSH 服务器",
    .mcp_servers_title = "MCP 服务器",
    .mcp_list_hint = "输入可筛选 \u{00b7} 回车编辑 \u{00b7} 空格启用/禁用",
    .mcp_search = "搜索 MCP 服务器",
    .mcp_new_server = "新建 MCP 服务器",
    .mcp_edit_json = "编辑 mcp.json",
    .mcp_close = "关闭",
    .mcp_v_file = "文件",
    .mcp_add_title = "新建 MCP 服务器",
    .mcp_edit_title = "编辑 MCP 服务器",
    .mcp_form_hint = "回车保存 \u{00b7} Tab/\u{2191}\u{2193} 切换 \u{00b7} Esc 返回",
    .mcp_test = "测试连接",
    .mcp_delete = "删除",
    .sl_cancel = "取消",
    .sl_save = "保存",
    ...
    .sl_hint_ssh_filter_choose_delete = "输入可筛选，Space 选择，回车删除选中项",
    .sl_hint_choose_server_delete = "Space 选择，回车删除选中项",
    .sl_ai_profile_name = "配置名称",
    .sl_ai_base_url = "接口地址",
    .sl_ai_api_key = "API 密钥",
    .sl_ai_acp_not_needed = "（ACP 无需填写）",
    ...
    .cmd_palette_filter_placeholder = "执行命令或选择主题…",
...
pub fn commandDetail(action: CommandAction) ?[]const u8 {
    ...
    return switch (action) {
        ...
        .open_memory_center => "查看 AI 记住的事实和 Memory Digest 摘要",
