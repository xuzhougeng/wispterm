...
const static_definitions = [_]Definition{
    .{ .name = "terminal_list", .label = "terminal_list", .description = "List this Agent's terminal surfaces; all-scope is metadata-only.", .category = .terminal },
    ...
    .{ .name = "terminal_snapshot", .label = "terminal_snapshot", .description = "Read a bounded text snapshot from an Agent-owned terminal.", .category = .terminal },
    ...
    .{ .name = "terminal_select", .label = "terminal_select", .description = "Select an Agent-owned terminal for subsequent write tools.", .category = .terminal },
    ...
    .{ .name = "terminal_reconnect", .label = "terminal_reconnect", .description = "Reconnect an exited Agent-owned SSH terminal in place.", .category = .terminal },
