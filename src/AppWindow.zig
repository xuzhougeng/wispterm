...
const ai_history_cache = @import("ai_history/cache.zig");
const ai_history_resume = @import("ai_history/resume.zig");
const ai_loop_store = @import("ai_loop_store.zig");
const ai_history_types = @import("ai_history/types.zig");
const ai_history_session = @import("ai_history/session.zig");
const ai_history_source = @import("ai_history/source.zig");
